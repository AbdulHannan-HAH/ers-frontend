...
export default function ChiefCourtFeeReports() {
  ...
  const fetchReports = async () => {
    try {
      const res = await axios.get(
        `https://ers-backend-f.onrender.com/api/court-fees/chief/all?court=${encodeURIComponent(selectedCourt)}`,
        {
  ...
  const markAsViewed = async (id) => {
    try {
      await axios.patch(`https://ers-backend-f.onrender.com/api/court-fees/chief/view/${id}`, {}, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const confirmReject = async () => {
    try {
      await axios.patch(
        `https://ers-backend-f.onrender.com/api/court-fees/chief/reject/${rejectModal.reportId}`,
